  ...
  <div class="dashboard">
    <div class="container">
      ...
      <div class="sensor-grid">
        ...
        <SensorCard
          title="Light Level"
          :value="sensorStore.currentReadings.lightLevel"
          unit="lux"
          icon="☀️"
          :min="sensorStore.thresholds.lightLevel.min"
          :max="sensorStore.thresholds.lightLevel.max"
        />
      </div>
...
onMounted(() => {
  // Start sensor data simulation (we will remove this when connecting to real backend)
